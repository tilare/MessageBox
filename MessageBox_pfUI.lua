...
local function skinDropDown(dd)
  if not dd or not canRun() then return end
  pcall(function()
    pfUI.api.SkinDropDown(dd)
  end)
end
...
function MessageBoxPfUI_ApplyAfterTheme()
  ...
  if f then
    ...
    if MessageBoxContextMenu then skinDropDown(MessageBoxContextMenu) end
    if MessageBoxSettingsDropDown then skinDropDown(MessageBoxSettingsDropDown) end
  end
...
function MessageBox_pfUISkin()
  ...
  if pfUI.skin["MessageBox"] then
    MessageBoxPfUI_ApplyAfterTheme()
    return
  end

  pfUI:RegisterSkin("MessageBox", "vanilla:tbc:wotlk", function()
    installHooks()
    MessageBoxPfUI_ApplyAfterTheme()
  end)
end
