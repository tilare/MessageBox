...
function MessageBox:GetCenteredString(text)
    ...
    local numSpaces = math.max(0, math.ceil(paddingRequired / spaceWidth) + 20)
...
function MessageBox:UpdateChatHistory()
    ...
    for i = 1, table.getn(allMessages) do
        ...
        -- Format the rest of the message as before
        if msg.system then
